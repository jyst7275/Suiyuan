...
class ProductAdmin(SummernoteModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': (
            ('product_name', 'product_category', 'product_status'), 'product_prize', 'product_date', 'product_img',
...
class OrderAdmin(admin.ModelAdmin):
    fields = (
    'order_index', ('order_buyer', 'order_username', 'order_cellphone'), 'order_date', 'order_address', 'order_total',
    'order_status')
    list_display = (
    'order_index', 'order_date', 'order_detail', 'order_total', 'order_username', 'order_address', 'order_cellphone',
    'order_status')
